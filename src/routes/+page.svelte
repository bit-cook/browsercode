...
<div class="relative h-full w-full overflow-hidden bg-bc-abyss text-zinc-300" use:wheelControl>
	...
	>
		...
		<div class="relative z-[2] flex flex-col items-center">
			...
			<p class="mb-8 max-w-md text-[15px] leading-relaxed text-white/60">
			...
			<div class="grid w-full max-w-xl gap-3 sm:grid-cols-2">
				<button
					onclick={goIde}
					class="group flex flex-col gap-3 rounded-xl border border-bc-azure/40 bg-bc-azure/10 p-4 text-left transition hover:border-bc-azure/60 hover:bg-bc-azure/15 focus-visible:border-bc-azure/70 focus-visible:outline-none"
				>
					<div class="flex items-center justify-between">
						<span
							class="flex h-9 w-9 items-center justify-center rounded-lg bg-bc-azure text-white shadow-[0_4px_14px_rgba(74,125,255,0.35)]"
						>
						...
						<Icon
							...
							width="16"
							height="16"
							class="text-bc-azure/70 transition group-hover:translate-x-0.5 group-hover:text-bc-azure"
						/>
					</div>
					<div>
						<div class="text-[14px] font-medium text-white">IDE for popular frameworks</div>
						<div class="mt-0.5 text-[12.5px] leading-relaxed text-white/60">
				...
				<button
					onclick={goAgents}
					class="glass-panel group flex flex-col gap-3 rounded-xl border border-bc-mist/12 p-4 text-left transition hover:border-bc-mist/30 focus-visible:border-bc-mist/40 focus-visible:outline-none"
				>
					<div class="flex items-center justify-between">
						<span
							class="flex h-9 w-9 items-center justify-center rounded-lg bg-bc-azure/15 text-bc-azure"
						>
						...
						<Icon
							...
							width="16"
							height="16"
							class="text-white/25 transition group-hover:translate-x-0.5 group-hover:text-white/60"
						/>
					</div>
					<div>
